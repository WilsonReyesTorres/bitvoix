...
/*
 * Membre Class
 * Cette classe est utilisé pour connecter, faire de requetes et insertions de membres bitvoix
 * @author    Milton Espitia
 * @url       https://www.bitvoix.com
 */
class Membre{
    ...
    public function insert($data){
        if(!empty($data) && is_array($data)){
            ...
            $values  = '';
            $i = 0;
            if(!array_key_exists('createdMembre',$data)){
                $data['createdMembre'] = date("Y-m-d H:i:s");
            }
