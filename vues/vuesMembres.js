...
function servicesAccueil(donnees) {
	rep = '<!-- Icons Services -->' +
		...
		'<div class="row">' +
		'<div class="col">' +
		'<button type="button" class="btn btn-primary btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'1\');"><i class="fas fa-car"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'1\');">Autos</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-warning btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'2\');"><i class="fas fa-heartbeat"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'2\');">Santé</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-success btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'3\');"><i class="fas fa-utensils"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'3\');">Gastronomie</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-danger btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'4\');"><i class="fas fa-star"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'4\');">Beauté</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-primary btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'5\');"><i class="fas fa-shopping-bag"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'5\');">Produits</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-warning btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'6\');"><i class="fas fa-plane"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'6\');">Voyages</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-success btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'7\');"><i class="fas fa-home"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'7\');">Maison</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-danger btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'8\');"><i class="fas fa-pencil-alt"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'8\');">Education</a>' +
		'</div>' +
		'<div class="col">' +
		'<button type="button" class="btn btn-primary btn-lg rounded-circle" onClick="requetesServ(\'montrerServicesCat\', \'9\');"><i class="fas fa-wrench"></i></button>' +
		'<a href="javascript:void(0);" onClick="requetesServ(\'montrerServicesCat\', \'9\');">Services</a>' +
		'</div>' +
		'</div>';
	...
	for (j = 0; j < donnees.length; j++) {
		...
		rep += '<li class="list-inline-item">' +
			...
			'<h6 class="card-text small">' + donnees[j].desVilAdr + '</h6>' +
			'<p class="card-text">' + donnees[j].desShortService + '</p>' +
			'<ul class="list-unstyled list-inline rating mb-0">';
		...
		rep += '<li class="list-inline-item">' +
			...
			'<button class="btn btn-outline-info font-weight-bold shadow">' + parseFloat(donnees[j].promService).toFixed(0) + '$</button>' +
			'<button class="btn btn-info font-weight-bold shadow">' + parseFloat(donnees[j].refeService).toFixed(0) + '$</button>' +
